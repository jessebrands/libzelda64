/*
 * allocator.c: default memory allocator
 ...
 */
static void* zelda64_std_malloc(void* opaque, size_t const size) {
 ...
 */
static void zelda64_std_free(void* opaque, void* ptr) {
    (void)opaque;
    free(ptr);
}
